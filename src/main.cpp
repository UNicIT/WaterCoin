...
uint256 hashGenesisBlock("0x8db7f8b387aec02d3b136e4b202bf0783e8c1332bbdb3b5abf307021305f6e63");
...
const string strMessageMagic = "watercoin Signed Message:\n";
...
static const int64 nTargetTimespan = 14 * 24 * 60 * 60; // watercoin: 14 days
static const int64 nTargetSpacing = 60; // watercoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal watercoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "watercoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x8db7f8b387aec02d3b136e4b202bf0783e8c1332bbdb3b5abf307021305f6e63");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Building WaterCoin on April 13, 2017!!!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1492507982; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 366765;

        if (fTestNet)
        {
            block.nTime    = 1492507982;
            block.nNonce   = 366765;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x0ad034eadae7333495c5eb4a99eeb291743cf405857eb865accd39a36d4a92bf"));
